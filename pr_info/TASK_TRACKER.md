...
- [x] Implementation: production code (`checker_tools.py`, `formatter_tools.py`) + tests (`test_checker_tools.py`, `test_formatter_tools.py`)
- [x] Quality checks: pylint, pytest, mypy — fix all issues
- [x] Commit message prepared

### Step 3: Update `test_server_params.py` patches
- [x] Implementation: test updates (`test_server_params.py`)
- [x] Quality checks: pylint, pytest, mypy — fix all issues
- [x] Commit message prepared
