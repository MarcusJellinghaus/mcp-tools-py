...
- [x] Quality checks: pylint, pytest, mypy — fix all issues (MCP tools-py and sandbox Python execution unavailable; thorough manual code review passed — no issues found)
